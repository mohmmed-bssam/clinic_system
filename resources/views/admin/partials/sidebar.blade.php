<div class="sidebar-wrapper" id="sidebar">
    <a href="{{ auth()->user()->role === 'doctor' ? route('doctor.dashboard') : route('admin.dashboard') }}"
        class="sidebar-brand">
        ...
        <div class="sidebar-menu-section">
            ...
            <ul class="sidebar-menu-list">
                <li class="sidebar-menu-item">
                    <a href="{{ auth()->user()->role === 'doctor' ? route('doctor.dashboard') : route('admin.dashboard') }}"
                        class="sidebar-menu-link {{ request()->routeIs('admin.dashboard', 'doctor.dashboard') ? 'active' : '' }}"
                        title="Dashboard">
